            ...
            <div className="flex gap-3 overflow-x-auto pb-1 flex-grow">
              {categories.map((category) => (
                <Button
                  key={category}
                  variant="outline"
                  className={`border border-[#d4c8bc] whitespace-nowrap px-4 transition-colors ${
                    selectedCategory === category
                      ...
                      : theme === "dark"
                        ...
                        : "bg-[#f8f5f2] text-[#5c4f42] hover:bg-[#e6ded5] hover:text-[#3c2f1f]"
                  }`}
            ...
            <div className="p-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                {filteredItems.length > 0 ? (
                  ...
                  <p className="col-span-full text-center py-8 text-[#8c7b6b]">
